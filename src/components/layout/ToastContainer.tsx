...
function ToastItem({
  ...
  return (
    <motion.div
      ...
      className={`flex items-center gap-3 min-w-[300px] max-w-[400px] px-4 py-3 rounded-lg bg-surface-0 border border-surface-200 border-l-4 ${borders[toast.type]} shadow-sm pointer-events-auto`}
    >
